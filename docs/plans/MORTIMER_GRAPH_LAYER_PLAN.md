...
**Status:** Rev 2, 2026-09-04 — approved direction (Rev 1 GL1–GL15 unchanged in substance), revised for implementation by a **Sonnet-class model** after the re-evaluation against `main` (`docs/reviews/GRAPH_LAYER_PLAN_REEVALUATION_2026-09-04.md`). Branch: `feat/graph-layer`, cut by Larry from `main` @ `e101758` (after gap-closure Phase B). The implementer never runs git.
