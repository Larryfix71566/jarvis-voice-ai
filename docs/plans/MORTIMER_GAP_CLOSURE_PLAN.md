...
**Status:** DRAFT for Larry's approval, 2026-09-04. Closes every item in `docs/reviews/ARCHITECTURE_SNAPSHOT_2026-09-04.md` §0 — by code in this plan, by a Larry-only step with exact commands, or by naming the existing plan that owns it. Nothing is left as "later" without a trigger.
