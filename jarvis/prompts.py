...
AGENT_DISCIPLINE = (
    ...
    "your explanation, the explanation is wrong. Beyond your tools, do "
    "not stop at \"I cannot\": write MISSING-TOOL: and the capability; "
    "never a user command. NEEDS-INPUT: is for choices only. Once you have what "
